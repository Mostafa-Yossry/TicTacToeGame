...
Mode GameConfiguration::getMode() const
{
    ...
    // Default return value, if no mode is checked (this should not happen if the UI is properly set up)
    return twoplayer;
}
 ...
 * @return A function which returns the unique instance of the game configuration class
 */
