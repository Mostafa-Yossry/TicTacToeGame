...
public:
    ...
    void setupUi(QDialog *GameConfiguration)
    {
        ...
        label->setStyleSheet(QString::fromUtf8("font: 700 20pt \"Arial\";\n"
"color: rgb(0, 0, 0);\n"
""));
        ...
        player1label->setStyleSheet(QString::fromUtf8("font: 700 11pt \"Arial\";\n"
"color: rgb(0, 0, 0);"));
        ...
        player2label->setStyleSheet(QString::fromUtf8("font: 700 11pt \"Arial\";\n"
"color: rgb(0, 0, 0);"));
        ...
        player1line->setStyleSheet(QString::fromUtf8("font: 10pt \"Arial\";\n"
"background-color: rgb(255, 255, 255);"));
        ...
        player2line->setStyleSheet(QString::fromUtf8("font: 10pt \"Arial\";\n"
"background-color: rgb(255, 255, 255);"));
        ...
        twoplayermode->setStyleSheet(QString::fromUtf8("font: 700 10pt \"Arial\";\n"
"color: rgb(0, 0, 0);"));
        ...
        AIMode->setStyleSheet(QString::fromUtf8("font: 12pt \"Arial\";\n"
"font: 700 10pt \"Arial\";\n"
"color: rgb(0, 0, 0);\n"
""));
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, GameConfiguration, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, GameConfiguration, qOverload<>(&QDialog::reject));
        QObject::connect(player1line, SIGNAL(textChanged(QString)), GameConfiguration, SLOT(updateOKButton()));
        QObject::connect(player2line, SIGNAL(textChanged(QString)), GameConfiguration, SLOT(updateOKButton()));
    ...
    {
        GameConfiguration->setWindowTitle(QCoreApplication::translate("GameConfiguration", "Dialog", nullptr));
        label->setText(QCoreApplication::translate("GameConfiguration", "Tic-Tac-Toe", nullptr));
        player1label->setText(QCoreApplication::translate("GameConfiguration", "Player 1", nullptr));
        player2label->setText(QCoreApplication::translate("GameConfiguration", "Player 2", nullptr));
        twoplayermode->setText(QCoreApplication::translate("GameConfiguration", "Two Player mode", nullptr));
        AIMode->setText(QCoreApplication::translate("GameConfiguration", "AI mode", nullptr));
    } // retranslateUi
