...
public:
    ...
    void setupUi(QMainWindow *ainWindow)
    {
        ...
        label->setStyleSheet(QString::fromUtf8("font: 700 31pt \"Arial\";\n"
"color: rgb(0, 0, 0);\n"
""));
    ...
    {
        ainWindow->setWindowTitle(QCoreApplication::translate("ainWindow", "MainWindow", nullptr));
        player1label->setText(QCoreApplication::translate("ainWindow", "playere 1", nullptr));
        player2label->setText(QCoreApplication::translate("ainWindow", "player 2", nullptr));
        label->setText(QCoreApplication::translate("ainWindow", "TIC-TAC-TOE  ", nullptr));
