...
constexpr auto qt_meta_stringdata_CLASSGameConfigurationENDCLASS =
    QtMocHelpers::stringData("GameConfiguration", "updateOKButton", "",
                             "on_buttonBox_clicked", "QAbstractButton*",
                             "button", "on_AIMode_clicked",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSGameConfigurationENDCLASS[] = {
    ...
    1, 0, 38, 2, 0x0a, 1 /* Public */, 3, 1, 39, 2, 0x08, 2 /* Private */, 6, 0,
    42, 2, 0x08, 4 /* Private */, 7, 0, 43, 2, 0x08, 5 /* Private */,
...
Q_CONSTINIT const QMetaObject GameConfiguration::staticMetaObject = {
    {QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
     ...
     qt_meta_data_CLASSGameConfigurationENDCLASS, qt_static_metacall, nullptr,
     qt_incomplete_metaTypeArray<
         qt_meta_stringdata_CLASSGameConfigurationENDCLASS_t,
         // Q_OBJECT / Q_GADGET
...
void GameConfiguration::qt_static_metacall(QObject *_o, QMetaObject::Call _c,
                                           int _id, void **_a) {
  if (_c == QMetaObject::InvokeMetaMethod) {
    ...
    switch (_id) {
      case 0:
        ...
        break;
      case 1:
        _t->on_buttonBox_clicked(
            (*reinterpret_cast<std::add_pointer_t<QAbstractButton *>>(_a[1])));
        break;
      case 2:
        _t->on_AIMode_clicked();
        break;
      case 3:
        _t->on_twoplayermode_clicked();
        break;
      default:;
    }
        ...
        switch (*reinterpret_cast<int *>(_a[1])) {
          ...
          case 0:
            *reinterpret_cast<QMetaType *>(_a[0]) =
                QMetaType::fromType<QAbstractButton *>();
            break;
        }
        break;
    }
...
void *GameConfiguration::qt_metacast(const char *_clname) {
  ...
  if (!strcmp(_clname,
              qt_meta_stringdata_CLASSGameConfigurationENDCLASS.stringdata0))
