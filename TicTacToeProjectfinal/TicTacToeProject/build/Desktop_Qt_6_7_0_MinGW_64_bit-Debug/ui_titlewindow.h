...
public:
    ...
    void setupUi(QMainWindow *TitleWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/icons8-new-48.png"), QSize(), QIcon::Normal, QIcon::On);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/images/icons8-close-window-48.png"), QSize(), QIcon::Normal, QIcon::On);
        ...
        verticalLayout->addWidget(player1label, 0, Qt::AlignHCenter|Qt::AlignVCenter);
        ...
        gametitle->setStyleSheet(QString::fromUtf8("font: 32pt \"Arial\";\n"
"color: rgb(0, 0, 0);"));

        verticalLayout->addWidget(gametitle, 0, Qt::AlignHCenter|Qt::AlignVCenter);
        ...
        verticalLayout->addWidget(newgameButton, 0, Qt::AlignHCenter|Qt::AlignVCenter);
        ...
        verticalLayout->addWidget(tictactoe, 0, Qt::AlignHCenter|Qt::AlignVCenter);

        player2label = new QLabel(centralwidget);
        player2label->setObjectName("player2label");

        verticalLayout->addWidget(player2label, 0, Qt::AlignHCenter|Qt::AlignVCenter);
    ...
    void retranslateUi(QMainWindow *TitleWindow)
    {
        ...
        actionNewgame->setText(QCoreApplication::translate("TitleWindow", "Newgame", nullptr));
#if QT_CONFIG(tooltip)
        actionNewgame->setToolTip(QCoreApplication::translate("TitleWindow", "New Game", nullptr));
#endif // QT_CONFIG(tooltip)
        actionQuitgame->setText(QCoreApplication::translate("TitleWindow", "QuitGame", nullptr));
#if QT_CONFIG(tooltip)
        actionQuitgame->setToolTip(QCoreApplication::translate("TitleWindow", "Quit Game", nullptr));
#endif // QT_CONFIG(tooltip)
        player1label->setText(QString());
        player1score->setText(QString());
        gametitle->setText(QCoreApplication::translate("TitleWindow", "Tic-Tac-Toe", nullptr));
        imagelabel->setText(QString());
        newgameButton->setText(QCoreApplication::translate("TitleWindow", "New", nullptr));
        registerbutton->setText(QCoreApplication::translate("TitleWindow", "Register", nullptr));
        player2label->setText(QString());
        player2score->setText(QString());
        menu_File->setTitle(QCoreApplication::translate("TitleWindow", "&File", nullptr));
        toolBar->setWindowTitle(QCoreApplication::translate("TitleWindow", "toolBar", nullptr));
    } // retranslateUi
